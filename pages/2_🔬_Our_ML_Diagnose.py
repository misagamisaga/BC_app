...
# st.header('Please enter your params here')

# col1, col2 = st.columns(2)
# with col1:
#    number_input('Insert a number')  
...
#         "MLPClassifier(hidden_layer_sizes=tuple([330, 240]),solver='lbfgs',alpha = 12.589254117941675, max_iter=65.0, verbose=True)", 
#         'GaussianNB()', 
#         'SVC(C=0.004086256180706494, gamma=0.00767147013532765, random_state=2, probability=True)', 
#         "XGBClassifier(objective='binary:logistic', learning_rate=0.3099376425986338, gamma=3.760043767458776, max_depth=2, seed=0, nthread=-1, scale_pos_weight = len(y[y == 0])/len(y[y == 1]))"
#     ]

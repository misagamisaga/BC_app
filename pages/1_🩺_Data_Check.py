...
upload_file = st.file_uploader("", accept_multiple_files=False, key=10)
...
if if_run:
    ...
    models = [
        ...
        # "LGBMClassifier()",
        "XGBClassifier(max_depth=5, learning_rate=0.1, n_estimators=160, silent=True, "

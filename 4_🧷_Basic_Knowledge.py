...
st.caption('''
All content on this page is from Wikipedia. 
You can click [here](https://en.wikipedia.org/wiki/Machine_learning) to access the original full page.
''')
...
Based on the concept of strong rules , Rakesh Agrawal, Tomasz Imieliń ski and Arun Swami introduced association rules for discovering regularities between products in large-scale transaction data recorded by point-of-sale (POS) systems in supermarkets. For example, the rule 
